exports.activationEmailv2 = (token, username) => {
  const emailPage = `
                                ...
                                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                  <tr>
                                    <td style="padding-right: 0px;padding-left: 0px;" align="center">
                                      ...
                                      <img align="center" border="0" src="https://assets.unlayer.com/projects/90201/1657945157238-title.png" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 32%;max-width: 179.2px;"
                                        width="179.2" />
                            ...
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                  <p style="font-size: 18px; line-height: 160%; text-align: left;">Hi there, </p>
                                  <p style="font-size: 18px; line-height: 160%; text-align: left;"> </p>
                                  <p style="font-size: 18px; line-height: 160%; text-align: left;">Thank you for registering an account with LOAD. You’re almost done!</p>
                                  <p style="font-size: 18px; line-height: 160%; text-align: left;"> </p>
                                  <p style="font-size: 18px; line-height: 160%; text-align: left;">To activate your account, please click the button below</p>
                                </div>
                          ...
                          <tbody>
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div align="center">
                                  <!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;font-family:'Cabin',sans-serif;"><tr><td style="font-family:'Cabin',sans-serif;" align="center"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:44px; v-text-anchor:middle; width:209px;" arcsize="9%" stroke="f" fillcolor="#ff0c50"><w:anchorlock/><center style="color:#FFFFFF;font-family:'Cabin',sans-serif;"><![endif]-->
                                  <a href="${process.env.CLIENT_URL}/activation?token=${token}" target="_blank" style="box-sizing: border-box;display: inline-block;font-family:'Cabin',sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #ff0c50; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                                    <span style="display:block;padding:14px 44px 13px;line-height:120%;">Activate My Account</span>
                                  </a>
                          ...
                          <tbody>
                            <tr>
                              <td style="overflow-wrap:break-word;word-break:break-word;padding:33px 55px 60px;font-family:'Cabin',sans-serif;" align="left">
                                ...
                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                  <p style="font-size: 18px; line-height: 160%; text-align: left;">If you did not make this request, please disregard this email. No LOAD ID will be created without verification.</p><br/>
                                </div>
  
                                <div style="line-height: 160%; text-align: center; word-wrap: break-word;">
                                  <p style="line-height: 160%; font-size: 18px; text-align: left;">Thanks,<br /><strong style="font-weight:700">LOAD Team</strong></p>
                                </div>
